    ...
    <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden min-h-screen flex flex-col justify-center bg-surface">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        <div className="flex items-center justify-center gap-3 mb-8">
          <span className="inline-flex items-center gap-1.5 px-4 py-1.5 rounded-full text-primary-container text-sm font-semibold border border-primary-container/20 border-4">
            <span className="material-symbols-outlined text-base">school</span>
            For Students
          </span>
          <span className="inline-flex items-center gap-1.5 px-4 py-1.5 rounded-full bg-surface-container-high text-on-surface text-sm font-semibold border border-surface-dim border-4">
        ...
        <h1 className="text-5xl md:text-7xl font-extrabold text-on-surface tracking-tight mb-6 max-w-4xl mx-auto leading-tight">
          The programming classroom, <br className="hidden md:block" />
          reimagined.
        </h1>

        <p className="mt-4 text-xl text-secondary max-w-2xl mx-auto mb-10">
          GAITS gives students a browser-based code editor with a guided AI
          tutor, and gives instructors a dedicated assignment module — all in a
          single platform.
        </p>
